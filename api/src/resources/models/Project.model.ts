...
const projectSchema = new Schema<IProject>({
  createdBy: {ref: 'UserProfile', index: true, required: true, type: Schema.Types.ObjectId},
  associatedTeam: {ref: 'Team', index: true, required: true, type: Schema.Types.ObjectId},
