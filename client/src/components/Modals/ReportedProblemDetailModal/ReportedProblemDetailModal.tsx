  ...
  return (
    <ModalWrapper modalHeaderProps={modalHeaderProps} visible={visible}>
      <div className="modal--container">
        ...
        <StackedLabel label="Reported On" content={FormattingUtils.formatDate(problem.createdAt, DATE_FORMATS['MEDIUM_DATE_TIME'])} />
        <StackedLabel label="Description of what happened" content={problem.content} />
        <StackedLabel label="Type of Problem" content={problem.problemType} />
        <StackedLabel label="Problem Status" content={problem.problemStatus} />
      </div>
    </ModalWrapper>
  );
};
